  ...
  return (
    <>
          ...
          onChange={(e) => {
            ...
            if (f)
              act("Saving style reference", async () => {
                ...
                change("referenceIds", [...style.referenceIds, a.id].slice(-3));
                setUploaded(
                  ...
                  onChange={(e) =>
                    change(
                      ...
                      e.target.checked
                        ...
                        : style.referenceIds.filter((v: string) => v !== a.id),
                    )
                  }
                />{" "}
                Use reference
      ...
      <details className="dish-options">
        ...
        <p className="fine">
          Set your actual hours for weekly suggestions. A closing time before
