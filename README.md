...
Visitors can prepare a photo before signing up; Generate image opens account creation with five free generations. Free keeps full-quality photos in every style, every download size, one live menu and posts in three designs. Pro is $9/month for 50 image generations per paid billing period, plus the restaurant look on everything, every post and menu design, campaigns, more live menus, saved looks, batches, staff links, full menu insights and no "Made with Menu Material" credit. The hosted site uses the existing live Stripe price; see [Free and Pro plans](docs/FREE_PRO_PLANS.md) for the feature split, credit rules and setup.
