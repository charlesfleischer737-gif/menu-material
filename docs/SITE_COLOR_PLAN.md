...
- **Public site:** a solid evergreen header with the reversed logo on every public page. On the homepage the logo's green glows down from the top edge of the page, through the header and into the evergreen hero, as one light: the header draws its part and moves it up with the page as it scrolls, so the two never show an edge. The band continues into the showcase wall; actions on evergreen are light stone pills and focus rings there are bright green. Then a stone use-case band with white cards, a white style gallery, the evergreen closing band and a stone footer. Pricing has a stone Free card and an evergreen Pro card. The visitor Photo Studio header stays frosted stone with ink links, and the phone menu is solid white.
