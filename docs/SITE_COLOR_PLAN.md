...
- **One dark color.** Evergreen ink `#12211a`, a near-black with the logo's green in it, is used for the workspace sidebar, the phone tab bar, primary buttons, selected chips, the homepage showcase and closing bands, the Explore closing card and the Pro plan card.
...
- **Public site:** a frosted stone header on every public page and in the visitor Photo Studio. On the homepage the header is solid stone, one surface with the stone hero at the top of the page, and gets its hairline once the page scrolls beneath it. The green starts with the showcase wall, an evergreen band lit from its top edge, where actions are light stone pills and focus rings are bright green. Then a stone use-case band with white cards, a white style gallery, the evergreen closing band and a stone footer. Pricing has a stone Free card and an evergreen Pro card. The phone menu is solid white.
