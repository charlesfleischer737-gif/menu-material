...
- **Public site:** a solid evergreen header with the reversed logo on every public page. On the homepage it runs straight into the evergreen hero in the same flat color; the hero's glow sits inside the band, clear of its edges, and the band continues into the showcase wall; actions on evergreen are light stone pills and focus rings there are bright green. Then a stone use-case band with white cards, a white style gallery, the evergreen closing band and a stone footer. Pricing has a stone Free card and an evergreen Pro card. The visitor Photo Studio header stays frosted stone with ink links, and the phone menu is solid white.
