...
23. **P2 · S — Correct plan availability messaging.** The workspace says “Get Pro” with a monthly price, and pricing describes continuing with Pro, while the actual Pro action says it is coming soon. Use an explicit availability label everywhere until subscriptions open, and make the currently available Free path the prominent action. Do not introduce a waitlist CTA unless a real waitlist workflow exists. Align desktop card action regions and keep unavailable-plan explanations readable.
